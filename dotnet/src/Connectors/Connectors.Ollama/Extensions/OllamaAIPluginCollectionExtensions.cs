...
/// </summary>
internal static class OllamaAIPluginCollectionExtensions
{
    /// <summary>
    /// Given an <see cref="OllamaFunction"/> object, tries to retrieve the corresponding <see cref="KernelFunction"/> and populate <see cref="KernelArguments"/> with its parameters.
    /// </summary>
    /// <param name="plugins">The plugins.</param>
    /// <param name="functionToolCall">The <see cref="OllamaFunction"/> object.</param>
    ...
    internal static bool TryGetFunctionAndArguments(
        ...
        OllamaFunction functionToolCall,
