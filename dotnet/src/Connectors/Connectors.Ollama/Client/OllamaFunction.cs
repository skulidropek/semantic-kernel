...
/// </summary>
internal sealed partial class OllamaFunction
{
    /// <summary>
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public OllamaParameters? Parameters { get; set; }
    ...
    /// <summary>
    /// Construct an instance of <see cref="OllamaFunction"/>.
    /// </summary>
    [JsonConstructorAttribute]
    public OllamaFunction(string name, string description, OllamaParameters? parameters)
    {
    ...
    /// Construct an instance of <see cref="OllamaFunction"/>.
    /// </summary>
    public OllamaFunction(KernelFunctionMetadata metadata)
    {
        ...
        this.Parameters = ToOllamaParameters(metadata);
    }

    /// <summary>
    /// Construct an instance of <see cref="OllamaFunction"/>.
    /// </summary>
    public OllamaFunction(string functionName, string? pluginName)
    {
    ...
    private static OllamaParameters ToOllamaParameters(KernelFunctionMetadata metadata)
    {
        var parameters = new OllamaParameters();
